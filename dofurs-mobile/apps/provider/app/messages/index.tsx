...
export default function PlaceholderScreen() {
  const messagesQuery = useQuery({
    ...
    queryFn: () => getMessages({ limit: 40, offset: 0 }),
  });
  ...
  return (
    <Screen scroll>
      ...
      <Text style={styles.subtitle}>Support, operations, and customer communication updates.</Text>
      ...
      {messages.map((message, index) => {
        ...
        const body = typeof row.body === 'string' ? row.body : (typeof row.message === 'string' ? row.message : 'No preview');
