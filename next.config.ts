...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.razorpay.com https://www.clarity.ms https://i.clarity.ms https://nominatim.openstreetmap.org https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://stats.g.doubleclick.net https://googleads.g.doubleclick.net https://www.googleadservices.com https://www.google.com https://www.google.co.in https://www.facebook.com https://connect.facebook.net https://graph.facebook.com",
