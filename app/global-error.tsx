...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body>
        <main className="mx-auto flex min-h-screen w-full max-w-[720px] flex-col items-center justify-center gap-4 px-6 text-center">
          <h1 className="text-2xl font-semibold text-ink">Unexpected application error</h1>
          <p className="text-sm text-[#7b6f66]">Please refresh and try again.</p>
