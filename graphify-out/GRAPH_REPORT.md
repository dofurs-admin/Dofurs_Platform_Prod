...
## Summary
- 1938 nodes · 3077 edges · 68 communities detected
...
Cohesion: 0.02
Nodes (33): hasValidPetAgePrecision(), isValidPetAgeValue(), buildBookingPricingSummary(), buildServiceLineBreakdown(), reconcileServiceLineTotals(), resolveAddonTotal(), resolveAddonUnitPrice(), calculateLightweightPetCompletion() (+25 more)
...
- **Thin community `Community 52`** (1 nodes): `SummaryCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `BookingsTabChunkV2.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
