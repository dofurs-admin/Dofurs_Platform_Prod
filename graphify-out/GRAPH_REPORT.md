...
## Summary
- 5448 nodes · 13599 edges · 104 communities detected
...
Cohesion: 0
Nodes (692): a(), aa(), Ac(), Ad(), add(), addChangeListener(), addEventListener(), addListener() (+684 more)
...
Cohesion: 0.01
Nodes (145): addListener(), ajax(), alpha(), Ao(), appendParams(), ar(), batchSend(), blur() (+137 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (22): __addChild(), canRun(), ct(), current(), find(), _getAccessToken(), __getChildren(), __getNativeConfig() (+14 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (81): a(), ae(), assertIsReady(), at(), b(), bindMethods(), cancelTasks(), clone() (+73 more)
...
Cohesion: 0.02
Nodes (20): __addChild(), canRun(), ct(), find(), __getAnimatedValue(), __getChildren(), getCurrentResult(), __getNativeConfig() (+12 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (51): cancelTimeout(), canPush(), channel(), clearHeartbeats(), computeViewableItems(), f(), flushSendBuffer(), getChannels() (+43 more)
...
Cohesion: 0.02
Nodes (41): add(), addChangeListener(), applyTransformOptsToQuery(), binaryEncode(), clear(), clearInteractionHandle(), configureNextLayoutAnimation(), createInteractionHandle() (+33 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (118): Ac(), Ad(), addEventListener(), Al(), an(), as(), bd(), bf() (+110 more)
...
Cohesion: 0.04
Nodes (59): addObserver(), build(), cancel(), cancelQueries(), cancelRefEvent(), clearGcTimeout(), clearTimeout(), close() (+51 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (15): clearInterval(), dp(), Eo(), __getNativeAnimationConfig(), getSize(), He(), hex(), hexa() (+7 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (17): connect(), connectWithFallback(), continue(), __debouncedOnEnd(), execute(), H(), isFocused(), onFocus() (+9 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (11): Be(), ep(), fetchThenEvalAsync(), g(), ge, le, Me(), oe() (+3 more)
...
## Knowledge Gaps
- **Thin community `Community 55`** (2 nodes): `global-error.tsx`, `GlobalError()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `manifest.ts`, `manifest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (2 nodes): `robots.ts`, `robots()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `QuickBookWidget.tsx`, `handleFind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (2 nodes): `DashboardShell.tsx`, `DashboardShell()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (2 nodes): `BookingSummarySidebar.tsx`, `formatDate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `PageLayout.tsx`, `PageLayout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `CreditBalanceWidget.tsx`, `formatServiceType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (2 nodes): `LoadingScreen.tsx`, `handleLoad()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (2 nodes): `SlotPickerGrid.tsx`, `formatTime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `onboarding.tsx`, `CustomerOnboardingScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `u()` connect `Community 11` to `Community 4`, `Community 17`, `Community 12`, `Community 14`, `Community 20`, `Community 6`, `Community 9`, `Community 15`, `Community 18`, `Community 10`, `Community 33`, `Community 19`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `r()` connect `Community 9` to `Community 4`, `Community 20`, `Community 11`, `Community 6`, `Community 18`, `Community 14`, `Community 10`, `Community 15`, `Community 12`, `Community 17`, `Community 19`?**
