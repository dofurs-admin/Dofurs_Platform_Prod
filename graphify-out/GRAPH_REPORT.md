...
## Summary
- 1598 nodes · 2477 edges · 67 communities detected
...
Cohesion: 0.04
Nodes (29): bucketTemplate(), getDaysSince(), isRecord(), runBillingReminderAutomation(), toBucket(), calculateAgeFromDOB(), formatDateInputValue(), formatISTDateTimeParts() (+21 more)
...
- **Thin community `Community 39`** (2 nodes): `manifest.ts`, `manifest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (2 nodes): `not-found.tsx`, `NotFound()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
