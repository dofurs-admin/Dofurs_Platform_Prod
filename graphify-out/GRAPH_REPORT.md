...
## Summary
- 5319 nodes · 13410 edges · 110 communities detected
...
Cohesion: 0.01
Nodes (194): addObserver(), ajax(), alpha(), Ao(), appendParams(), ar(), batchSend(), blur() (+186 more)
...
Cohesion: 0.01
Nodes (167): addListener(), ajax(), alpha(), Ao(), appendParams(), applyTransformOptsToQuery(), ar(), batchSend() (+159 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (85): a(), ae(), assertIsReady(), at(), b(), bindMethods(), cancel(), cancelTasks() (+77 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (80): a(), add(), addEventListener(), addListener(), ae(), assertIsReady(), at(), b() (+72 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (58): cancelTimeout(), canPush(), channel(), clearHeartbeats(), clearInteractionHandle(), close(), closeAndRetry(), configureNextLayoutAnimation() (+50 more)
...
Cohesion: 0.02
Nodes (40): add(), addChangeListener(), clear(), clearInteractionHandle(), clearInterval(), componentWillUnmount(), computeViewableItems(), configureNextLayoutAnimation() (+32 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (67): addObserver(), cancelRefEvent(), cancelTimeout(), canPush(), channel(), clearGcTimeout(), clearHeartbeats(), clearTimeout() (+59 more)
...
Cohesion: 0.02
Nodes (28): __addChild(), canRun(), continue(), ct(), __debouncedOnEnd(), execute(), find(), __getAnimatedValue() (+20 more)
...
Cohesion: 0.04
Nodes (135): aa(), af(), ai(), ba(), bc(), bi(), bo(), br() (+127 more)
...
Cohesion: 0.03
Nodes (115): Ac(), Ad(), addEventListener(), Al(), an(), as(), bd(), bf() (+107 more)

### Community 19 - "Community 19"
Cohesion: 0.02
Nodes (16): __addChild(), canRun(), ct(), find(), __getAnimatedValue(), __getChildren(), __getNativeConfig(), __getNativeTag() (+8 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (31): addChangeListener(), binaryEncode(), clear(), csv(), decode(), encode(), exists(), geojson() (+23 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (80): Al(), an(), as(), bd(), bn(), bp(), Bt(), Cd() (+72 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (25): Ad(), cancelQueries(), clearInterval(), clearTimeout(), dd(), __debouncedOnEnd(), Eo(), fetchInfiniteQuery() (+17 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (15): Be(), bf(), ep(), fetchThenEvalAsync(), g(), ge, le, Me() (+7 more)
...
Cohesion: 0.05
Nodes (43): bp(), build(), defaultMutationOptions(), defaultQueryOptions(), dispose(), dp(), du(), enqueueTasks() (+35 more)
...
Cohesion: 0.05
Nodes (27): build(), componentWillUnmount(), defaultMutationOptions(), defaultQueryOptions(), dispose(), emitChange(), enqueueTasks(), ensureInfiniteQueryData() (+19 more)
...
- **Thin community `Community 71`** (2 nodes): `onboarding.tsx`, `CustomerOnboardingScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `sign-in.tsx`, `handleSendOtp()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `pets.tsx`, `toPetRow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `profile.tsx`, `handleSignOut()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 76`** (2 nodes): `review.tsx`, `handleSubmitReview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (2 nodes): `addons.tsx`, `handleContinue()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (2 nodes): `pet.tsx`, `handleContinue()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (2 nodes): `edit.tsx`, `handleSave()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (2 nodes): `passport.tsx`, `PlaceholderScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 84`** (2 nodes): `application-status.tsx`, `handleCheckStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `collect.tsx`, `handleCollect()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `complete.tsx`, `handleComplete()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `documents.tsx`, `handleCreate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `auth.ts`, `auth-store.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 102`** (1 nodes): `help.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `expo-env.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `schedule.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `dashboard-queries.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (1 nodes): `owner-profile.database.types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `u()` connect `Community 14` to `Community 4`, `Community 25`, `Community 11`, `Community 10`, `Community 24`, `Community 5`, `Community 13`, `Community 18`, `Community 16`, `Community 34`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `u()` connect `Community 19` to `Community 2`, `Community 27`, `Community 7`, `Community 20`, `Community 23`, `Community 12`, `Community 9`, `Community 22`, `Community 6`, `Community 21`, `Community 35`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `r()` connect `Community 12` to `Community 2`, `Community 23`, `Community 19`, `Community 6`, `Community 22`, `Community 20`, `Community 7`, `Community 9`, `Community 21`, `Community 27`?**
