...
## Summary
- 1847 nodes · 2912 edges · 68 communities detected
...
Cohesion: 0.02
Nodes (27): hasValidPetAgePrecision(), isValidPetAgeValue(), formatDateLabel(), formatDateTime(), formatTimeLabel(), calculateCompletion(), loadProfile(), normalizePetGenderValue() (+19 more)
...
Cohesion: 0.03
Nodes (32): getErrorCode(), isMissingColumnError(), loadBookingAddonRowsByBookingIds(), formatBookingDateTime(), formatDate(), formatDateTime(), formatTime(), addAddon() (+24 more)
