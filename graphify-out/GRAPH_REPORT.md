...
## Summary
- 1572 nodes · 2426 edges · 63 communities detected
...
Cohesion: 0.03
Nodes (22): calculateCompletion(), loadProfile(), normalizePetGenderValue(), saveCurrentStep(), buildStepPayload(), canLeaveCurrentContext(), handleNextOrComplete(), handler() (+14 more)
...
Cohesion: 0.04
Nodes (77): haversineDistanceKm(), toRadians(), normalizeOptionalString(), validateEmergencyPhones(), addDays(), buildBundleSummaryNote(), buildCalendarCacheKey(), buildCandidateQueue() (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (9): formatDateLabel(), formatDateTime(), formatTimeLabel(), extractBookedPetIds(), extractBookedServices(), formatBookingTime(), formatBookingTimeRange(), resolveBookingPetLabels() (+1 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (27): getErrorCode(), isMissingColumnError(), loadBookingAddonRowsByBookingIds(), formatBookingDateTime(), formatBookingMode(), formatDate(), formatDateTime(), formatTime() (+19 more)
...
Cohesion: 0.04
Nodes (23): createCustomerProfileForBooking(), CustomerIntakeError, isPrivilegedRole(), normalizeExistingUser(), normalizeRoleName(), toFriendlyCreateUserError(), extractIndianPhoneDigits(), toIndianE164() (+15 more)
...
Cohesion: 0.05
Nodes (24): calculateAgeFromDOB(), formatDateInputValue(), formatISTDateTimeParts(), getISTTimestamp(), getPetDateOfBirthBounds(), isPetDateOfBirthWithinBounds(), createServiceInvoice(), createSubscriptionInvoice() (+16 more)
...
Cohesion: 0.07
Nodes (16): computeBookingOutstandingInr(), getBookingOutstandingSummary(), getCapturedOnlineAmountForBooking(), getSettledManualAmountForBooking(), evaluateDiscountForBooking(), normalizeServiceType(), roundCurrency(), createRazorpayOrder() (+8 more)
...
Cohesion: 0.18
Nodes (9): applyDiscount(), calculateDiscountAmount(), roundCurrency(), calculateAddOnTotal(), calculateBookingPriceWithSupabase(), isSchemaMissingError(), loadAddonServiceTypes(), normalizeErrorCode() (+1 more)
...
## Knowledge Gaps
- **Thin community `Community 34`** (2 nodes): `global-error.tsx`, `GlobalError()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `manifest.ts`, `manifest()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `not-found.tsx`, `NotFound()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `robots.ts`, `robots()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `QuickBookWidget.tsx`, `handleFind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `DashboardShell.tsx`, `DashboardShell()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (2 nodes): `BookingSummarySidebar.tsx`, `formatDate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `PageLayout.tsx`, `PageLayout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (2 nodes): `CreditBalanceWidget.tsx`, `formatServiceType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (2 nodes): `SlotPickerGrid.tsx`, `formatTime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `loading.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
