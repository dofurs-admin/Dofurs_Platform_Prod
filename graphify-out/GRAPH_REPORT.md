...
## Summary
- 1891 nodes · 3002 edges · 67 communities detected
...
Cohesion: 0.02
Nodes (24): hasValidPetAgePrecision(), isValidPetAgeValue(), calculateLightweightPetCompletion(), calculatePetCompletionFromSections(), derivePetCompletionSections(), hasText(), buildStepPayload(), canLeaveCurrentContext() (+16 more)
...
Cohesion: 0.03
Nodes (13): isNavHidden(), MobileBottomNav(), isInvalidRefreshTokenError(), loadCurrentUser(), getNotificationHref(), getNumberFromUnknown(), addDays(), getDayName() (+5 more)
...
Cohesion: 0.04
Nodes (24): calculateCompletion(), loadProfile(), normalizePetGenderValue(), saveCurrentStep(), openCreateServiceModal(), parseOptionalInteger(), parseOptionalNumber(), resetServiceDraft() (+16 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (13): formatDateLabel(), formatDateTime(), formatTimeLabel(), getEffectiveBookingStatus(), matchesBookingFilter(), extractBookedPetIds(), extractBookedServices(), formatBookingTime() (+5 more)
...
Cohesion: 0.08
Nodes (4): formatServiceCoveragePincode(), hasServiceCoverageForPincode(), isBengaluruCityCoveragePincode(), serviceCoveragePincodeMatches()
...
- **Thin community `Community 46`** (2 nodes): `CreditBalanceWidget.tsx`, `formatServiceType()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `LoadingScreen.tsx`, `handleLoad()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `SlotPickerGrid.tsx`, `formatTime()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `google-ads.test.ts`, `importGoogleAdsModule()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
