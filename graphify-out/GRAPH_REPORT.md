...
## Summary
- 1788 nodes · 2807 edges · 64 communities detected
...
Cohesion: 0.09
Nodes (16): getGroomingPackageByServiceType(), getGroomingPackagePriceByServiceType(), normalizeSearchText(), normalizeServiceType(), assertPublicBookableService(), assertPublicBookableServiceType(), hasAnyToken(), isGenericGroomingServiceQuery() (+8 more)
