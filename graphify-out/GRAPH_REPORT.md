...
## Summary
- 1785 nodes · 2804 edges · 65 communities detected
...
Cohesion: 0.02
Nodes (11): formatDateLabel(), formatDateTime(), formatTimeLabel(), isInvalidRefreshTokenError(), loadCurrentUser(), mapProfileToDraft(), normalizeGroomingFrequencyValue(), normalizePetGenderValue() (+3 more)
...
Cohesion: 0.04
Nodes (21): calculateLightweightPetCompletion(), calculatePetCompletionFromSections(), derivePetCompletionSections(), hasText(), claimPendingPetShares(), hasText(), listAccessiblePetsForUser(), normalizeEmail() (+13 more)
...
Cohesion: 0.05
Nodes (25): calculateAgeFromDOB(), formatDateInputValue(), formatISTDateTimeParts(), getISTTimestamp(), getPetDateOfBirthBounds(), isPetDateOfBirthWithinBounds(), createServiceInvoice(), createSubscriptionInvoice() (+17 more)
